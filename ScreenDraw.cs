...
namespace AsteroidsVita
{
	public static class ScreenDraw
	{
	    ...
	    public static bool Initialize(GraphicsContext graphicsContext, Stopwatch swInit = null)
	    {
	#if ENABLE_PERFORMANCE_MEASUREMENT
			long startElapsed = swInit.ElapsedMilliseconds;
			long lastElapsed;
	...
	#if ENABLE_PERFORMANCE_MEASUREMENT
			lastElapsed = swInit.ElapsedMilliseconds;
			Console.WriteLine("SampleDraw::Init::createShader*2 ElapsedTime = {0}ms\n", lastElapsed - startElapsed);
	#endif	// ENABLE_PERFORMANCE_MEASUREMENT
	...
	#if ENABLE_PERFORMANCE_MEASUREMENT
			lastElapsed = swInit.ElapsedMilliseconds;
			Console.WriteLine("SampleDraw::Init::MatrixSetup ElapsedTime = {0}ms\n", swInit.ElapsedMilliseconds - lastElapsed);
	#endif	// ENABLE_PERFORMANCE_MEASUREMENT
	...
	#if ENABLE_PERFORMANCE_MEASUREMENT
			lastElapsed = swInit.ElapsedMilliseconds;
			Console.WriteLine("SampleDraw::Init::VertexBufferSetup ElapsedTime = {0}ms\n", swInit.ElapsedMilliseconds - lastElapsed);
	#endif	// ENABLE_PERFORMANCE_MEASUREMENT
	...
	#if ENABLE_PERFORMANCE_MEASUREMENT
			Console.WriteLine("SampleDraw::Init::FontSetup ElapsedTime = {0}ms\n", swInit.ElapsedMilliseconds - lastElapsed);
			lastElapsed = swInit.ElapsedMilliseconds;
	#endif	// ENABLE_PERFORMANCE_MEASUREMENT
	...
	#if ENABLE_PERFORMANCE_MEASUREMENT
			Console.WriteLine("SampleDraw::Init::spriteDictSetup ElapsedTime = {0}ms\n", swInit.ElapsedMilliseconds - lastElapsed);
			lastElapsed = swInit.ElapsedMilliseconds;
	#endif	// ENABLE_PERFORMANCE_MEASUREMENT
	
	#if ENABLE_PERFORMANCE_MEASUREMENT
			Console.WriteLine("SampleDraw::Init Total ElapsedTime = {0}ms\n", swInit.ElapsedMilliseconds - startElapsed); 
	#endif	// ENABLE_PERFORMANCE_MEASUREMENT
	    ...
	    {
			string ResourceName = "AsteroidsVita.shaders.Texture.cgx";
	    ...
	    {
			string ResourceName = "AsteroidsVita.shaders.Simple.cgx";
